...
| Resource | Description |
|---|---|
| [AI Security Control Map](https://github.com/Cchinyere/information-security-ai-governance/tree/main/ai-governance/ai-security-control-map) | A practitioner reference for AI security controls, GRC, compliance, internal audit, and regulated financial services. |
| [AI System Register Template](https://github.com/Cchinyere/information-security-ai-governance/blob/main/ai-governance/ai-security-control-map/ai-system-register-template.md) | A template for documenting AI systems, ownership, use cases, data categories, risk level, and review status. |
| [AI Governance Policy Template](https://github.com/Cchinyere/information-security-ai-governance/blob/main/ai-governance/ai-security-control-map/ai-governance-policy-template.md) | A policy template for responsible, secure, and controlled AI adoption. |
| [AI Vendor Due Diligence Checklist](https://github.com/Cchinyere/information-security-ai-governance/blob/main/ai-governance/ai-security-control-map/ai-vendor-due-diligence-checklist.md) | A checklist for assessing third-party AI providers, embedded AI tools, and AI-related supplier risk. |
